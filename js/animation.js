...
if($('body, html').width() <= 576){
  $(window).scroll(function() {
    ...
    if (scrollTop >= section5 - 80) {
      ...
      $('.section-5 .book-container').delay(2000).css("opacity", "1");
      setTimeout(function() {
        $('.section-5 .icon:nth-child(1)').css("height", "40px");
      }, 300);
      setTimeout(function() {
        $('.section-5 .icon:nth-child(2)').css("height", "40px");
      }, 500);
      setTimeout(function() {
        $('.section-5 .icon:nth-child(3)').css("height", "40px");
      }, 700);
      setTimeout(function() {
        $('.section-5 .icon:nth-child(4)').css("height", "40px");
      }, 900);
    }
    //section 6 animation
    if (scrollTop >= section6) {
    ...
    if (scrollTop >= section7 - 80) {
      ...
      $('.section-7 .book-container').delay(2000).css("opacity", "1");
      setTimeout(function() {
        $('.section-7 .icon:nth-child(1)').css("height", "40px");
      }, 300);
      setTimeout(function() {
        $('.section-7 .icon:nth-child(2)').css("height", "40px");
      }, 500);
      setTimeout(function() {
        $('.section-7 .icon:nth-child(3)').css("height", "40px");
      }, 700);
      setTimeout(function() {
        $('.section-7 .icon:nth-child(4)').css("height", "40px");
      }, 900);
    }
    //section 8 animation
    if (scrollTop <= section8 && scrollTop >= section8 - 50) {
